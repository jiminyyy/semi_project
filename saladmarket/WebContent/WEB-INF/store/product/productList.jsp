    ...
    <div id="page">
         <div class="colorlib-shop">
            ...
            <c:forEach  var="product" items="${productList}" varStatus="status">
               <div class="col-md-3 text-center">
                  <div class="product-entry">
                     <div class="product-img" style="background-image: url(img/${product.pimgfilename});">
                        <p class="tag"><span class="sale">${product.fk_stname}</span></p><!-- sale이라는 클래스가 디자인이 걸려 있어서 그냥 클래스는 sale로 할께요 -->
                        <div class="cart">
                           <p>
                              <span class="addtocart"><a href="cart.html"><i class="icon-shopping-cart"></i></a></span> 
                              <span><a href="product-detail.html"><i class="icon-eye"></i></a></span> 
                     ...
                     <div class="desc">
                        <h3><a href="<%=CtxPath%>/productDetail.do">${product.fk_pacname}</a></h3>
                        <p class="price" style="font-weight: bold;"><span>${product.saleprice}원</span>&nbsp;<span class="sale">${product.price}원</span> </p>
                     </div>
                  </div>
               </div>
