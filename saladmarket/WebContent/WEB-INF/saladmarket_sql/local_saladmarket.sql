...
alter table member modify(pwd varchar2(200) not null); 
...
insert into my_coupon values('leess', 2, add_months(sysdate, 3));
commit;
select *
from member;
...
values(10, '없음', '건강차', '식사대용/간식용', 'NEW', '없음', '[겨울향기] 자몽청 950g', 10000, 8800, 880
...
insert into product(pnum, fk_pacname, fk_sdname, fk_ctname, fk_stname, fk_etname, pname, price, saleprice, point
             , pqty, pcontents, pcompanyname, weight)
values(11, '없음', '건강차', '식사대용/간식용', 'NEW', '없음', '[겨울향기] 유자청 1kg', 10000, 7700, 770
     , 100, '손 끝이 차갑게 아려오는 날, 따끈한 과일차를 호르륵 마시는 느낌은 참 각별해요.
     코 끝에 감겨 오는 풍성한 과일향과 입 안 가득한 달콤함은 생각만 해도 기분이 좋아지죠.
...
insert into product(pnum, fk_pacname, fk_sdname, fk_ctname, fk_stname, fk_etname, pname, price, saleprice, point
             , pqty, pcontents, pcompanyname, weight)
values(12, '없음', '건강차', '식사대용/간식용', 'NEW', '없음', '[겨울향기] 레몬청 950g', 10000, 8800, 880
     , 100, '손 끝이 차갑게 아려오는 날, 따끈한 과일차를 호르륵 마시는 느낌은 참 각별해요. 
     코 끝에 감겨 오는 풍성한 과일향과 입 안 가득한 달콤함은 생각만 해도 기분이 좋아지죠. 
...
insert into product(pnum, fk_pacname, fk_sdname, fk_ctname, fk_stname, fk_etname, pname, price, saleprice, point
             , pqty, pcontents, pcompanyname, weight)
values(13, '없음', '건강차', '식사대용/간식용', 'BEST', '없음', '[겨울향기] 한라봉청 950g', 10000, 8800, 880
     , 100, '손 끝이 차갑게 아려오는 날, 따끈한 과일차를 호르륵 마시는 느낌은 참 각별해요. 
     코 끝에 감겨 오는 풍성한 과일향과 입 안 가득한 달콤함은 생각만 해도 기분이 좋아지죠. 
...
insert into product(pnum, fk_pacname, fk_sdname, fk_ctname, fk_stname, fk_etname, pname, price, saleprice, point
             , pqty, pcontents, pcompanyname, weight)
values(14, '없음', '건강즙', '식사대용/간식용', 'BEST', '없음', '[참든건강] 아이달콤 도라지배즙 (20포)', 30000, 25000, 2500
...
insert into product(pnum, fk_pacname, fk_sdname, fk_ctname, fk_stname, fk_etname, pname, price, saleprice, point
             , pqty, pcontents, pcompanyname, weight)
values(15, '없음', '건강즙', '식사대용/간식용', 'BEST', '없음', '[장수이야기] 순진한 포도즙 10포', 20000, 16000, 1600
...
insert into product(pnum, fk_pacname, fk_sdname, fk_ctname, fk_stname, fk_etname, pname, price, saleprice, point
             , pqty, pcontents, pcompanyname, weight)
values(16, '없음', '건강즙', '식사대용/간식용', 'HIT', '없음', '[담아본] 유기농 호박즙', 35000, 32000, 3200
...
insert into product(pnum, fk_pacname, fk_sdname, fk_ctname, fk_stname, fk_etname, pname, price, saleprice, point
             , pqty, pcontents, pcompanyname, weight)
values(17, '없음', '건강즙', '식사대용/간식용', 'BEST', '없음', '[그란테] 100% 착즙 석류주스', 20000, 18000, 1800
...
select seq_product_pnum.nextval
from dual; 
...
update product_package set paccontents = '찬바람이 불기 시작하면 귤의 계절입니다. 겨우내 이불속에서 티비와 함께 부족한 비타민을 충전하세요. 다른 과일에 비해 귤은 친환경으로 재배한 것이 맛이 월등히 좋답니다.'
where pacnum = 6;

update product_package set pacnum = 6 where pacnum = 7;
...
,'찬바람이 불기 시작하면 귤의 계절입니다. 겨우내 이불속에서 티비와 함께 부족한 비타민을 충전하세요. 다른 과일에 비해 귤은 친환경으로 재배한 것이 맛이 월등히 좋답니다.'
,'자연마을',default,'감귤'
...
alter table member add(pwd varchar2(200));
update member set pw ='9695b88a59a1610320897fa84cb7e144cc51f2984520efb77111d94b402a8382' where userid='leess';
alter table member modify(pwd varchar2(200) not null); 
